...
let bootstrap_oracle () =
    ...
    let orig = Test.originate_from_file oracle_path init_storage 0mutez in
    let oracle_contract = Test.to_contract orig.addr in

    (oracle_contract, orig.addr, elon, jeff, alice, bob, james)
